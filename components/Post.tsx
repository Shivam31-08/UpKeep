...
function Post({post} : Props){
    ...
    const displayVotes = (data:any) =>{
        ...
        if(displayNumber ===0)
        {
            ...
            //the vote is never zero it either positive or negative 
        }
    ...
    return (
        <Link href={`/post/${post.id}`}>
            <div className='flex  my-5 cursor-pointer rounded-md border border-gray-300 bg-white shadow-sm hover-border hover:border-gray-600 '>
                {/* Votes */}
                ...
                <div className='p-3 pb-1'>
                        ...
                        <Avatar seed={post.subreddit?.topic} />
                            <p className='text-xs text-gray-400'>
                                <Link href={`/subreddit/${post.subreddit?.topic}`}>
                                    <span className='font-bold text-black hover:text-blue-400 hover:underline'>r/{post.subreddit?.topic}</span> • Posted by u/{post.username} <TimeAgo date={post.created_at}/>
                                </Link>
                            </p>
                    </div>
                    ...
                    <div className='py-4'>
                        ...
                        <p className='mt-2 test-sm font-light'>{post.body}</p>
                    ...
                    <div className='flex space-x-4 text-gray-400'>
                        ...
                        <div className='postButtons'>
                            ...
                            {/* Hidden on the small screen but visible on the big ones */}
                        </div>
                        <div className='postButtons'>
